...
def load_encoded_songs(encoded_path):
    load_path = os.path.join(encoded_path,'Master_File' )
...
def main():
    ...
    songs = load_encoded_songs(ENCODED_PATH)
    ...
    mapped_songs = map_file(songs,MAPPING_PATH)
    print(mapped_songs)
